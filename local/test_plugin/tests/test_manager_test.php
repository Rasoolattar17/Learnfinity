 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class test_manager_test extends advanced_testcase {
    ...
    public function test_constructor() {
        ...
        $manager = new test_manager($user->id);
        
        $this->assertInstanceOf(test_manager::class, $manager);
    }

    /**
     * Test creating a test record.
     */
    public function test_create_test_record() {
        $this->resetAfterTest();
     ...
     */
    public function test_get_test_data() {
        $this->resetAfterTest();
        ...
        $manager->create_test_record('Record 1', 'Description 1');
        $manager->create_test_record('Record 2', 'Description 2');
        
        $data = $manager->get_test_data();
        
        $this->assertIsArray($data);
        $this->assertCount(2, $data);
        $this->assertEquals('Record 2', $data[0]->name); // Should be sorted by timecreated DESC.
    }

    /**
     * Test updating a test record.
     */
    public function test_update_test_record() {
        $this->resetAfterTest();
     ...
     */
    public function test_delete_test_record() {
        $this->resetAfterTest();
